package com.example.abhiw.calculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupUI(){
        ...
        plus = (Button) findViewById(R.id.bTambah);
        minus = (Button) findViewById(R.id.bKurang);
        mul = (Button) findViewById(R.id.bKali);
        div = (Button) findViewById(R.id.bBagi);
        equal = (Button) findViewById(R.id.bSamaDengan);
        Clear = (Button) findViewById(R.id.bClear);
        Delete = (Button) findViewById(R.id.bDel);
        result = (TextView) findViewById(R.id.result);
        info = (TextView) findViewById(R.id.calculate);
